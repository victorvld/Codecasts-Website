...
//    private UseCaseFactorySpy factorySpy;
//
//    // Our goal is to check the request model is created properly and pass through the boundary.
//    @BeforeEach
//    void setUp() {
//        TestSetup.setupSampleData();
//        factorySpy = new UseCaseFactorySpy();
//        controller = new CodecastSummariesController(factorySpy);
//    }
//
//    @Test
...
//
//        Assertions.assertTrue(factorySpy.makeWasCalled);
//    }
